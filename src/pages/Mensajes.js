        ...
        <div>
          <div className="card">
            ...
            {tab === 'mensaje2' && (
              <>
                <div className="form-field">
                  <label className="form-label">Texto botón — Sí</label>
                  <input className="form-input" value={current.boton_si} onChange={e => setCurrent(c => ({ ...c, boton_si: e.target.value }))} />
                </div>
                <div className="form-field">
                  <label className="form-label">Texto botón — No</label>
                  <input className="form-input" value={current.boton_no} onChange={e => setCurrent(c => ({ ...c, boton_no: e.target.value }))} />
                </div>
              </>
            )}
                ...
                <div className="preview-bubble">
                  ...
                  {tab === 'mensaje2' && (
                    <div className="preview-buttons">
                      <div className="preview-btn-yes">{current.boton_si}</div>
                      <div className="preview-btn-no">{current.boton_no}</div>
                    </div>
                  )}
