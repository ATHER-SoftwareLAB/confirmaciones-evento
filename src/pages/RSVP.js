...
export default function RSVP() {
  ...
  const fechaEvento = evento?.evento_fecha ? new Date(evento.evento_fecha + 'T00:00:00') : null
...
const S = {
  ...
  image: { width: '100%', display: 'block', maxHeight: 420, objectFit: 'contain' },
  card: {
  ...
  dateText: { fontSize: 14, color: '#c9a96e', textTransform: 'capitalize' },
